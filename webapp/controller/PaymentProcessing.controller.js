sap.ui.define([
	...
	return Controller.extend("com.apptech.app-bankinteg.controller.PaymentProcessing", {
		...
		fGetAllBatch: function(){
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app-xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBankIntegration&QUERYTAG=getAllBatch&VALUE1=&VALUE2=&VALUE3=&VALUE4=",
				type: "GET",
				async: false,
				dataType: "json",
		...
		fGetAllRecord: function (queryTag) {
			var aReturnResult = [];
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app-xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBankIntegration&QUERYTAG=getAllRecord&VALUE1=&VALUE2=&VALUE3=&VALUE4=",
				type: "GET",
				async: false,
				dataType: "json",
				beforeSend: function (xhr) {
		...
		fGetAllSupplier: function(){
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app-xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBankIntegration&QUERYTAG=getAllBPwithOpenAP&VALUE1=&VALUE2=&VALUE3=&VALUE4=",
				type: "GET",
				async: false,
				dataType: "json",
				beforeSend: function (xhr) {
		...
		getSearchDataHead: function(dbName,procName,queryTag,value1,value2,value3,value4){
			//get all open AP base on parameters
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app-xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName="+ procName +"&QUERYTAG=" + queryTag
		...
		getSearchDataDet: function(dbName,procName,queryTag,value1,value2,value3,value4){
			...
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app-xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBankIntegration&QUERYTAG=" + queryTag
				+"&VALUE1="+ value1 +"&VALUE2="+ value2 +"&VALUE3="+ value3 +"&VALUE4=",
				type: "GET",
				async: false,
				dataType: "json",
				...
				for (iCounter = 0; iCounter < this.oMdlAP.getData().allopenAP.length; iCounter++) {
					...
					iRow = selectedIndeices[iCounter2];
						if (iRow === iCounter) {
							...
							CheckDate = CheckDate.split("undefined").join("");
		...
		deleteIfExisting: function(oDetailsCode,Type){
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app-xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBankIntegration&QUERYTAG=CheckIfExist"
