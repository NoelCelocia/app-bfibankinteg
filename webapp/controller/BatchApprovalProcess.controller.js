sap.ui.define([
	...
	return Controller.extend("com.apptech.app-bankinteg.controller.BatchApprovalProcess", {
		...
		fGetAllRecord: function (queryTag) {
			var aReturnResult = [];
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app-xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBankIntegration&QUERYTAG=getAllSavedRecord&VALUE1=&VALUE2=&VALUE3=&VALUE4=",
				type: "GET",
				async: false,
				dataType: "json",
				beforeSend: function (xhr) {
			...
			$.ajax({
				...
				if (results) {
					...
					for (var d = 0; d < results.length; d++) {
						...
						oRecordDetails.oBatchNum = results[d].oBatchNum;
